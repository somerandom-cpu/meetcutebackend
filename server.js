...
// Serve uploads directory with explicit CORS headers
...
// Add a specific route to serve profile pictures with proper headers
app.get('/uploads/profile-pictures/:filename', (req, res) => {
  const filename = req.params.filename;
  const filePath = path.join(uploadsPath, 'profile-pictures', filename);
